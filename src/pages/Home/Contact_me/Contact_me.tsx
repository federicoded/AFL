...
const Contact_me = forwardRef<HTMLHeadingElement, ContactMeProps>(({ id }, ref) => {
    ...
    return (
        <div className="CM_container" >
            <div className="cm_side photo_side">
                {
                    ////// REMPLAZAR CON FORMAS DIFERENTES PARA MANIPULAR CON
            ...
            <div className="cm_side texts">
                <h1 ref={aspectRatio > 1 ? ref : null} id={aspectRatio > 1 ? id : undefined} className="link_target cm_title">Mi nombre es Alejandra,</h1>
                <h2 className="cm_subtitle">Soy Técnica Superior en Grafología y docente con más de 25 años de experiencia en educación con niños, adolescentes y adultos.</h2>
                <h2 className="cm_subtitle">Contactame por whatsapp o por email para conocer tu caso</h2>
                <ul className="cm_buttons_container">
                    <li className="cm_button_single_container">
                        <a className="cm_button wpp" href="https://wa.me/5493446404615" target="_blank" rel="noopener noreferrer">
                            <svg fill="#199d28" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="cm_button_single_container">
                        <a href="mailto:alejandra@fripplozano.com.ar" className="cm_button" target="_blank" >
                            <svg fill="#000e88" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul className="cm_buttons_container socials">
                    <li className="cm_button_single_container">
                        <a href="https://www.facebook.com/profile.php?id=61578053049473" target="_blank" rel="noopener noreferrer">
                            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="socials_logo expand_animation">
